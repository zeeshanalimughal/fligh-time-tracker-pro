...
<body
  ...
  <div style="display: none;">A request to reset password was received from your Flight Time Tracker Pro Account</div>
  <div role="article" aria-roledescription="email" aria-label="Reset your Password" lang="en">
                  ...
                  <tr>
                    <td class="sm-px-24"
                      ...
                      <p style="margin: 0 0 24px;">
                        This is the password reset OTP you requested from Flight Time Tracker. Use to reset your Flight Time Tracker Pro account password.
                      </p>
                      ...
                      <p style="margin: 20px 0 2px;">
                        ...
                        <br>Flight Time Tracker Pro Support
                      </p>
                      ...
                      <p style="margin: 0 0 16px;">
                        ...
                        <a href="mailto:zeeshanaliryk18@gmail.com" class="hover-underline"
                          style="--text-opacity: 1; color: #7367f0; text-decoration: none;">zeeshanaliryk18@gmail.com</a>.
                      </p>
                    </td>
                  </tr>
                  <tr>
    ...
    const text = `
        Reset Password, You recently requested to reset your password for your Flight Time Tracker Pro account. Copy and paste it for reset password:
        ${otp}
