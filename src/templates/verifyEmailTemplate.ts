const verifyEmail = function (otp: string) {
    ...
    <body
      ...
      <div style="display: none;">A request to create your Flight Time Tracker Pro account was received.
                      ...
                      <tr>
                        <td class="sm-px-24"
                          ...
                          <p style="margin: 0 0 24px;">
                            A request to create your Flight Time Tracker Pro account was received.
Use this link to confirm your account and log in
                          ...
                          <p style="margin: 0 0 16px;">Thanks, <br>The Flight Time Tracker Pro Support Team</p>
                        </td>
                      </tr>
                      <tr>
    ...
    const text = `
        Verify Email, A request to create your Flight Time Tracker Pro account was received.
